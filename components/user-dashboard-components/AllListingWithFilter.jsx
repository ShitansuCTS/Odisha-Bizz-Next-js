                ...
                <SheetContent side="right" className="w-full max-w-lg bg-white shadow-xl rounded-xs overflow-hidden">
                    ...
                    {selectedListing && (
                        ...
                        >
                            ...
                            {/* Contact */}
                            <Label htmlFor="status" className="mb-2 font-medium text-gray-700">Phone No</Label>
                            <Input label="Phone" name="phone" value={selectedListing.phone} onChange={handleChange} />

                            {/* Email */}
                            <Label htmlFor="status" className="mb-2 font-medium text-gray-700">Email Info</Label>
                            <Input label="Email" name="email" value={selectedListing.email} onChange={handleChange} />

                            {/* Address */}
                            {["district", "state", "pincode"].map((field) => (
                                <div key={field}>
                                    <Label htmlFor="status" className="mb-2 font-medium text-gray-700">{field.charAt(0).toUpperCase() + field.slice(1)}</Label>
                                    <Input
                                        key={field}
                            ...
                            {["facebook", "instagram", "twitter", "linkedin", "website"].map((sm) => (
                               <div key={sm}>
                                    <Label htmlFor="status" className="mb-2 font-medium text-gray-700">{sm.charAt(0).toUpperCase() + sm.slice(1)}</Label>
                                    <Input
                                        key={sm}
